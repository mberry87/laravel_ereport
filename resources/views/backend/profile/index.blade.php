        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    @endif
                    <form action="{{ route('profile.update.avatar', auth()->user()->id) }}" method="POST"
                        ...
                        <form action="{{ route('profile.update.data', auth()->user()->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_perusahaan"
                                    value="{{ auth()->user()->nama_perusahaan }}" required>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea type="text" class="form-control" name="alamat" rows="3" required>{{ auth()->user()->alamat }}</textarea>
                            </div>
                    </div>
                    <button class="btn btn-primary btn-sm mr-3" type="submit">
                        <i class="fas fa-undo"></i>
