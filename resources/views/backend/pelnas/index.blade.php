        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-header">Tambah PELNAS</div>
                        <div class="card-body">
                            <a href="{{ route('pelnas.datang.create') }}" class="btn btn-primary btn-sm mb-3 mr-3">
                                <i class="fas fa-backward mr-3"></i>Datang
                            </a>
                            <a href="{{ route('pelnas.berangkat.create') }}" class="btn btn-danger btn-sm mb-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pelnas.index') }}" method="GET">
                                ...
                                <a class="btn btn-secondary btn-sm d-inline" href="{{ route('pelnas.index') }}">
                    ...
                    <div class="modal fade" id="cetakLaporan" tabindex="-1" aria-labelledby="cetakLaporanLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('pelnas.laporan') }}" method="POST">
                                    @csrf
                            ...
                            @foreach ($pelnas as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('pelnas.datang.edit', $data->id) }}"
                                            class="btn btn-warning btn-sm mr-2 d-inline" data-toggle="tooltip"
                                            title="edit datang">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('pelnas.berangkat.edit', $data->id) }}"
                                            class="btn btn-warning btn-sm mr-2  d-inline" data-toggle="tooltip"
