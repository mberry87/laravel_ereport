...
<div class="row">
    <div class="col-md-12">
        <div class="card collapsed-card">
            ...
            <div class="card-body" style="display: none;">
                <form action="{{ route('bup.index') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary btn-sm" href="{{ route('bup.index') }}">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Data BUP</div>
            <div class="card-body">
                <a href="{{ route('bup.create') }}" class="btn btn-primary btn-sm">
