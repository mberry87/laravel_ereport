...
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary btn-sm" href="{{ route('pbm.index') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('pbm.create') }}" class="btn btn-primary btn-sm">
                ...
                <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->bongkar }}</td>
                            <td>
                                <a href="{{ route('pbm.show', $data->id) }}"
                                    class="btn btn-success btn-sm mr-2 text-center" data-toggle="tooltip" title="show">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('pbm.edit', $data->id) }}"
...
<div class="modal fade" id="cetakLaporan" tabindex="-1" aria-labelledby="cetakLaporanLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('pbm.laporan') }}" method="POST" formtarget="_blank" target="_blank">
                @csrf
