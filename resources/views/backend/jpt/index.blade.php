...
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary btn-sm" href="{{ route('jpt.index') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('jpt.create') }}" class="btn btn-primary btn-sm">
...
<div class="modal fade" id="cetakLaporan" tabindex="-1" aria-labelledby="cetakLaporanLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('jpt.laporan') }}" method="POST" formtarget="_blank" target="_blank">
                @csrf
