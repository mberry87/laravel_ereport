...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-2">
                    <a href="{{ route('tersus.create') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus-circle mr-3"></i>Tambah
                    </a>
                    <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal"
                        data-target="#cetakLaporan">
                ...
                <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('tersus.show', $data) }}" class="btn btn-success btn-sm mr-2 d-inline text-center"
                                    data-toggle="tooltip" title="detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('tersus.edit', $data->id) }}"
                                    class="btn btn-warning btn-sm mr-2 d-inline text-center" data-toggle="tooltip" title="edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('tersus.destroy', $data->id) }}?delete=true"
                                    class="btn btn-danger btn-sm mr-2  d-inline text-center" data-toggle="tooltip" title="hapus"
                                    id="btn-hapus">
    ...
    <div class="modal fade" id="cetakLaporan" tabindex="-1" aria-labelledby="cetakLaporanLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('tersus.laporan') }}" method="POST" formtarget="_blank" target="_blank">
                    @csrf
