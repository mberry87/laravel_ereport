                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pelabuhan_datang" id="id_pelabuhan_datang" class="form-control">
                                    ...
                                    <option value="{{ $data->id }}" {{ ($data->id == $tersus->id_pelabuhan_datang) ? 'selected' : ''}}>{{ $data->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="id_terminal_datang" id="id_terminal_datang" class="form-control">
                                    ...
                                    <option value="{{ $data->id }}" {{ ($data->id == $tersus->id_terminal_datang) ? 'selected' : ''}}>{{ $data->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Jumlah bongkar</label>
                                <input type="text" name="jumlah_bongkar_datang" class="form-control" required value="{{ $tersus->jumlah_bongkar_datang }}">
                            </div>
                            <div class="form-group">
                                <label>Jenis muatan</label>
                                <input type="text" name="jenis_muatan_datang" class="form-control" required value="{{ $tersus->jenis_muatan_datang }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
