...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Data Terminal</li>
</ol>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">Data Terminal</div>
            <div class="card-body">
                <a href="{{ route('terminal.create') }}" class="btn btn-primary btn-sm mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('terminal.destroy', $data) }}?delete=true"
