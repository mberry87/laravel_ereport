    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('user.reset.password', $user->id) }}" onclick="return confirm('reset password User ini?')" class="btn btn-warning btn-sm mr-2 d-inline">
                    <i class="fas fa-key mr-2"></i>
                    reset password
                </a>
                <a href="{{ route('user.reset.status', $user->id) }}" onclick="return confirm('update status user ini?')" class="btn btn-warning btn-sm mr-2 d-inline">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            @if ($user->avatar == null)
                            <img src="https://ui-avatars.com/api/?size=128&name={{ $user->name }}" class="img-thumbnail"
                                width="128" alt="img">
                            @else
                            <img src="https://ui-avatars.com/api/?size=128&name={{ $user->name }}" class="img-thumbnail"
                                width="128" alt="img">
