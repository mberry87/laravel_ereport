    ...
    <div class="col-md-12">
        <div class="card collapsed-card">
            ...
            <div class="card-body" style="display: none;">
                <form action="{{ route('keagenan_kapal.index') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary btn-sm" href="{{ route('keagenan_kapal.index') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('keagenan_kapal.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('keagenan_kapal.edit', $data->id) }}"
                                    class="btn btn-warning btn-sm mr-2 text-center" data-toggle="tooltip" title="edit">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cetakLaporanLabel">Cetak Laporan Keagenan Kapal</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('keagenan_kapal.laporan') }}" method="POST" formtarget="_blank" target="_blank">
                @csrf
