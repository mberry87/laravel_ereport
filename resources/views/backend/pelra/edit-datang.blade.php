...
@section('title', 'Edit Pelra Datang')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('pelra.datang.update', $pelra->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_pelabuhan_datang" id="id_pelabuhan_datang" class="form-control">
                                        @foreach ($pelabuhan as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $data->id == $pelra->id_pelabuhan_datang ? 'selected' : '' }}>
                                                {{ $data->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="jenis_muatan_datang" class="form-control" required
                                                value="{{ $pelra->jenis_muatan_datang }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Bongkar</label>
                                            <input type="text" name="bongkar_tonm3" class="form-control" required
                                                value="{{ $pelra->bongkar_tonm3 }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
