    ...
    <div class="col-md-12">
        <div class="card collapsed-card">
            ...
            <div class="card-body" style="display: none;">
                <form action="{{ route('pelra.index') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary btn-sm" href="{{ route('pelra.index') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('pelra.create') }}" class="btn btn-primary btn-sm">
                ...
                <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pelra.show', $data->id) }}" class="btn btn-success btn-sm mr-2 text-center"
                                    data-toggle="tooltip" title="detail">
                                    <i class="fas fa-eye"></i>

                                </a>
                                <a href="{{ route('pelra.edit', $data->id) }}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cetakLaporanLabel">Cetak Laporan Pelra</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('pelra.laporan') }}" method="POST" formtarget="_blank" target="_blank">
                @csrf
