        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('pelra.datang.edit', $pelra->id) }}"
                        class="btn btn-warning btn-sm mr-2 d-inline mx-3 ">
                        <i class="fas fa-edit mr-2"></i>
                        Edit kedatangan
                    </a>
                    <a href="{{ route('pelra.berangkat.edit', $pelra->id) }}" class="btn btn-warning btn-sm d-inline">
                        <i class="fas fa-edit mr-2"></i>
                        Edit keberangkatan
                    </a>
                </div>
                    ...
                    <table class="table table-striped table-sm">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 5%">:</td>
                                <td>{{ $pelra->jenis_muatan_datang != null ? $pelra->jenis_muatan_datang : '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
